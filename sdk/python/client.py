...
class SentinelAlphaClient:
    ...
    def scan(self, contract_address: str, chain: str = "base", lane: str = "basic", context: dict | None = None) -> dict:
        payload = {
            "contract_address": contract_address,
            "chain": chain,
            "context": context,
        }
        return self._request("POST", "/contracts/risk-score", json_payload=payload, lane=lane)

    def risk_score(self, contract_address: str, chain: str = "base", lane: str = "basic", context: dict | None = None) -> dict:
        return self.scan(contract_address=contract_address, chain=chain, lane=lane, context=context)
