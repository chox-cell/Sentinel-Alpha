...
| `payment_hash` | x402 / Lightning payment context | Optional payment/settlement surface reference | `reports/trust_loop/minimum_verifiable_loop.sample.json` | yes | no | not_persisted | not_integrated |
