...
- v13.0 first-revenue loop — ReaWorks Trust Receipt ($25 outside review): **packet sent** (`REAWORKS_REVIEW_PACKET_001.md` + redacted JSON, 2026-05-20); **payment pending**; **review pending**; no revenue confirmed; no paid-customer claim
